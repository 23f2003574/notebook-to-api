...
def _dispatch_core_command(args):
    ...
    if args.command == "doctor":
        ...
        if args.json_output:
            ...
            print(f"  deploy smoke test timeout: {config.get('deploy_smoke_test_timeout_seconds')}s")
...
def main():
    ...
    search_functions_parser.add_argument(
        ...
        help=(
            ...
            "(comma-separated), mirroring GET /api/functions' own "
            "?tags= -- something --tag alone can't express. See "
